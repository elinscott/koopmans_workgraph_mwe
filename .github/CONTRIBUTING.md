...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at
   [`elinscott/koopmans-workgraph-mwe`](https://github.com/elinscott/koopmans-workgraph-mwe)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with
   `git clone https://github.com/<your namespace here>/koopmans-workgraph-mwe.git`
...
```shell
$ git remote add elinscott https://github.com/elinscott/koopmans-workgraph-mwe.git
```
